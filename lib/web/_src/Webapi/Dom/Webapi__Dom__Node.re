module Impl = (T: {type t;}) => {
  ...
  external firstChild: T.t => option(Dom.node);
  ...
  [@bs.get] [@bs.return nullable]
  external nextSibling: T.t => option(Dom.node);
  ...
  [@bs.get] [@bs.return nullable]
  external parentElement: T.t => option(Dom.element);
  [@bs.get] [@bs.return nullable]
  external parentNode: T.t => option(Dom.node);
  [@bs.get] [@bs.return nullable]
  external previousSibling: T.t => option(Dom.node);
  ...
  [@bs.send.pipe: T.t]
  external compareDocumentPosition: Dom.node_like('a) => int; /* returns a bitmask which could also be represeneted as an enum, see https://developer.mozilla.org/en-US/docs/Web/API/Node/compareDocumentPosition */
