...
and Lower_case_closed_element :
  sig type t = { tag : string; attributes : Attribute.t array; } end
and Element :
  sig
    type t =
...
val createElement :
  string -> Attribute.t array -> Element.t list -> Element.t
val cloneElement :
  Element.t -> Attribute.t array -> Element.t list -> Element.t
...
val useEffect3 :
  ...
  'dependency1 * 'dependency2 * 'dependency3 -> unit
val useEffect4 :
  (unit -> (unit -> unit) option) ->
  'dependency1 * 'dependency2 * 'dependency3 * 'dependency4 -> unit
val useEffect5 :
  (unit -> (unit -> unit) option) ->
