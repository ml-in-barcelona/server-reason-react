...
(* type domRef
   ...
   let domProps
       ...
       ?(ariaDisabled: bool option)
       ?(ariaHidden: bool option)
       ...
       ?(ariaModal: bool option)
       ?(ariaMultiline: bool option)
       ?(ariaMultiselectable: bool option)

       ?(ariaPlaceholder: string option)

       ?(ariaReadonly: bool option)
       ?(ariaRequired: bool option)
       ?(ariaSelected: bool option)
       ...
       ?(ariaAtomic: bool option)
       ?(ariaBusy: bool option)
       ...
       ?(method_: string option) (* as method *)
       ?(min: string option)
       ...
       ?(name: string option)
       ?(nonce: string option)
       ?(noValidate: bool option)
       ?(open_: bool option) (* as open *)
       ?(optimum: int option)
       ?(pattern: string option)
       ?(placeholder: string option)
       ?(playsInline: bool option)
