...
external parentNode: option(Dom.node);
[@bs.send.pipe: t] [@bs.return nullable]
external firstChild: option(Dom.node);
[@bs.send.pipe: t] [@bs.return nullable] external lastChild: option(Dom.node);
[@bs.send.pipe: t] [@bs.return nullable]
external previousSibling: option(Dom.node);
[@bs.send.pipe: t] [@bs.return nullable]
external nextSibling: option(Dom.node);
[@bs.send.pipe: t] [@bs.return nullable]
external previousNode: option(Dom.node);
