module React_component_with_props =
  struct
    include
      struct
        let makeProps ~lola:(lola : 'lola) ?key:(key : string option) () =
          (Obj.magic
             (let (__js_obj_cell_0, __js_obj_entry_0) =
              ...
              Js.Obj.Internal.register_structural __js_obj
                [__js_obj_entry_0; __js_obj_entry_1]) : < lola: 'lola   > 
                                                          Js.t)
...
module Forward_Ref =
  struct
    include
      struct
        let makeProps ~children:(children : 'children)
          ~buttonRef:(buttonRef : 'buttonRef) ?key:(key : string option) () =
          (Obj.magic
             (let (__js_obj_cell_0, __js_obj_entry_0) =
              ...
              let (__js_obj_cell_1, __js_obj_entry_1) =
                Js.Obj.Internal.slot_ref ~method_name:"buttonRef"
                  ~js_name:"buttonRef" ~present:true buttonRef in
...
module Onclick_handler_button =
  struct
    include
      struct
        let makeProps ~name:(name : 'name)
          ?isDisabled:(isDisabled : 'isDisabled option)
          ?key:(key : string option) () =
          (Obj.magic
             (let (__js_obj_cell_0, __js_obj_entry_0) =
                Js.Obj.Internal.slot_ref ~method_name:"name" ~js_name:"name"
                  ~present:true name in
              let (__js_obj_cell_1, __js_obj_entry_1) =
                Js.Obj.Internal.slot_ref ~method_name:"isDisabled"
                  ~js_name:"isDisabled"
                  ~present:(match isDisabled with
                            | None -> false
                            | Some _ -> true) isDisabled in
              let (__js_obj_cell_2, __js_obj_entry_2) =
                Js.Obj.Internal.slot_ref ~method_name:"key" ~js_name:"key"
                  ~present:(match key with | None -> false | Some _ -> true)
                  key in
        ...
        let make
          ...
          =
          make ?key:((Obj.magic Props : < key: string option   > )#key)
            ~name:(Props#name) ?isDisabled:(Props#isDisabled) ()
      end
  end
module Children_as_string =
  struct
    include
      struct
        let makeProps ?name:(name : 'name option) ?key:(key : string option)
          () =
          (Obj.magic
             (let (__js_obj_cell_0, __js_obj_entry_0) =
                Js.Obj.Internal.slot_ref ~method_name:"name" ~js_name:"name"
...
module Uppercase_with_SSR_components =
  struct
    include
      struct
        let makeProps ~children:(children : 'children)
          ~moreProps:(moreProps : 'moreProps) ?key:(key : string option) () =
          (Obj.magic
             (let (__js_obj_cell_0, __js_obj_entry_0) =
                Js.Obj.Internal.slot_ref ~method_name:"children"
                  ~js_name:"children" ~present:true children in
              let (__js_obj_cell_1, __js_obj_entry_1) =
                Js.Obj.Internal.slot_ref ~method_name:"moreProps"
                  ~js_name:"moreProps" ~present:true moreProps in
              let (__js_obj_cell_2, __js_obj_entry_2) =
                Js.Obj.Internal.slot_ref ~method_name:"key" ~js_name:"key"
                  ~present:(match key with | None -> false | Some _ -> true)
                  key in
          ...
          React.Upper_case_component
            (Stdlib.__FUNCTION__,
              (fun () ->
                 React.createElement "form"
                   (Stdlib.List.filter_map Stdlib.Fun.id
                      [(match (`String "" : [ `String of string 
                                            | `Function of
                                                'a Runtime.server_function ])
                        with
                        | `String s ->
                            Some
                              (React.JSX.String
                 ...
                 React.createElement "div"
                   (Stdlib.List.filter_map Stdlib.Fun.id
                      [Some
                         (React.JSX.String
                            ("class", "className",
                              ("async-component" : string)))]) [children]))
        let make (Props : < children: 'children   >  Js.t) =
          make ?key:((Obj.magic Props : < key: string option   > )#key)
            ~children:(Props#children) ()
      end
