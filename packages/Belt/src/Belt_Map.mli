...
val eqU : ('k, 'v, 'id) t -> ('k, 'v, 'id) t -> (('v -> 'v -> bool)[@bs]) -> bool
...
val mergeU :
  ('k, 'v, 'id) t -> ('k, 'v2, 'id) t -> (('k -> 'v option -> 'v2 option -> 'v3 option)[@bs]) -> ('k, 'v3, 'id) t
...
val partitionU : ('k, 'v, 'id) t -> (('k -> 'v -> bool)[@bs]) -> ('k, 'v, 'id) t * ('k, 'v, 'id) t
