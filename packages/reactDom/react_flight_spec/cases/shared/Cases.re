...
let all: list(case) = [
  ...
  case("hint_preload_style", Hint_preload_style.app),
  case("hint_preconnect", Hint_preconnect.app),
  case("hint_prefetch_dns", Hint_prefetch_dns.app),
  case("hint_preinit_script", Hint_preinit_script.app),
  case("hint_dedup", Hint_dedup.app),
  case("hint_before_client_ref", Hint_before_client_ref.app),
