...
(** Resource hints, following react-dom's flight-side API. During [ReactServerDOM.render_model] they emit [H] rows into
    the Flight stream, deduplicated per request; outside a flight render they are no-ops. See
