...
let just_an_html_node () =
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head></head><script data-payload='0:[\"$\",\"html\",null,{\"children\":[]},null,[],null]\n\
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head></head><body></body><script \
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"head\",null,{\"children\":[]},null,[],null],[\"$\",\"body\",null,{\"children\":[]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
...
let no_head_no_body_nothing_just_an_html_node () =
  ...
  assert_html app
    ~shell:
      "<input /><script data-payload='0:[\"$\",\"input\",null,{},null,[],null]\n'>window.srr_stream.push()</script>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head></head><input /><script \
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"input\",null,{},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head></head><body><div>Just body content</div></body><script \
       ...
       body content\"]},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><title>Titulaso</title><meta charset=\"utf-8\" /></head><script \
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"head\",null,{\"children\":[[\"$\",\"title\",null,{\"children\":[\"Titulaso\"]},null,[],null],[\"$\",\"meta\",null,{\"charSet\":\"utf-8\"},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<div><html></html></div><script \
       data-payload='0:[\"$\",\"div\",null,{\"children\":[[\"$\",\"html\",null,{\"children\":[]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head></head><div></div><script \
       data-payload='0:[[\"$\",\"html\",null,{\"children\":[[\"$\",\"div\",null,{\"children\":[]},null,[],null]]},null,[],null]]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><meta charset=\"utf-8\" /><title>Implicit Head?</title></head><script \
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"meta\",null,{\"charSet\":\"utf-8\"},null,[],null],[\"$\",\"title\",null,{\"children\":[\"Implicit \
  ...
  assert_html app ~bootstrapModules:[ "react"; "react-dom" ] ~bootstrapScriptContent:"console.log('hello')"
    ~shell:
      "<!DOCTYPE html><html><head><link rel=\"modulepreload\" fetchPriority=\"low\" href=\"react\" /><link \
       ...
       /><script \
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"input\",null,{\"id\":\"sidebar-search-input\"},null,[],null]]},null,[],null]\n\
  ...
  assert_html app ~bootstrapModules:[ "react"; "react-dom" ] ~bootstrapScriptContent:"console.log('hello')"
    ~shell:
      "<!DOCTYPE html><html><head><link rel=\"modulepreload\" fetchPriority=\"low\" href=\"react\" /><link \
       ...
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"body\",null,{\"children\":[[\"$\",\"input\",null,{\"id\":\"sidebar-search-input\"},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script><script>console.log('hello')</script><script src=\"react\" async=\"\" \
       type=\"module\"></script><script src=\"react-dom\" async=\"\" type=\"module\"></script></html>"
  ...
  assert_html app ~bootstrapModules:[ "react"; "react-dom" ] ~bootstrapScriptContent:"console.log('hello')"
    ~shell:
      "<input id=\"sidebar-search-input\" /><script \
       data-payload='0:[\"$\",\"input\",null,{\"id\":\"sidebar-search-input\"},null,[],null]\n\
       '>window.srr_stream.push()</script><script>console.log('hello')</script><script src=\"react\" async=\"\" \
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><title>Hey Yah</title><meta name=\"viewport\" \
       ...
       Yah\"]},null,[],null],[\"$\",\"meta\",null,{\"name\":\"viewport\",\"content\":\"width=device-width,initial-scale=1\"},null,[],null]]},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><script async \
       ...
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"body\",null,{\"children\":[[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"https://cdn.com/jquery.min.js\"},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
...
let async_scripts_gets_deduplicated () =
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><script async \
       src=\"https://cdn.com/jquery.min.js\"></script></head><body></body><script \
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"body\",null,{\"children\":[[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"https://cdn.com/jquery.min.js\"},null,[],null],[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"https://cdn.com/jquery.min.js\"},null,[],null],[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"https://cdn.com/jquery.min.js\"},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><script async src=\"https://cdn.com/duplicated.js\"></script></head><body><script \
       ...
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"body\",null,{\"children\":[[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"https://cdn.com/duplicated.js\"},null,[],null],[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"https://cdn.com/duplicated.js\"},null,[],null],[\"$\",\"script\",null,{\"children\":[],\"async\":false,\"src\":\"https://cdn.com/non-async.js\"},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><link href=\"https://cdn.com/main.css\" rel=\"stylesheet\" precedence=\"high\" \
       ...
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"body\",null,{\"children\":[[\"$\",\"link\",null,{\"href\":\"https://cdn.com/main.css\",\"rel\":\"stylesheet\",\"precedence\":\"high\"},null,[],null],[\"$\",\"link\",null,{\"href\":\"https://cdn.com/main.css\",\"rel\":\"stylesheet\",\"precedence\":\"low\"},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><link href=\"https://cdn.com/main.css\" rel=\"stylesheet\" precedence=\"low\" \
       ...
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"body\",null,{\"children\":[[\"$\",\"link\",null,{\"href\":\"https://cdn.com/main.css\",\"rel\":\"stylesheet\",\"precedence\":\"low\"},null,[],null],[\"$\",\"link\",null,{\"href\":\"favicon.ico\",\"rel\":\"icon\"},null,[],null],[\"$\",\"link\",null,{\"href\":\"favicon.ico\",\"rel\":\"icon\"},null,[],null],[\"$\",\"link\",null,{\"href\":\"http://www.example.com/xmlrpc.php\",\"rel\":\"pingback\"},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app ~bootstrapModules:[ "jquery"; "jquery-mobile" ]
    ~shell:
      "<!DOCTYPE html><html><head><link rel=\"modulepreload\" fetchPriority=\"low\" href=\"jquery\" /><link \
       ...
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"body\",null,{\"children\":[[\"$\",\"script\",null,{\"children\":[],\"async\":false,\"src\":\"https://cdn.com/jquery.min.js\"},null,[],null]]},null,[],null]]},null,[],null]\n\
  ...
  assert_html
    ~shell:
      "<div><input /><p>unsafe!</p></div><script \
       data-payload='0:[\"$\",\"div\",null,{\"children\":[[\"$\",\"input\",null,{},null,[],null],[\"$\",\"p\",null,{\"dangerouslySetInnerHTML\":{\"__html\":\"unsafe!\"}},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script>"
    app
  ...
  assert_html
    ~shell:
      "<!DOCTYPE html><html><head><meta char-set=\"utf-8\" /><style>* { display: none; }</style></head><script \
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"head\",null,{\"children\":[[\"$\",\"meta\",null,{\"charSet\":\"utf-8\"},null,[],null],[\"$\",\"style\",null,{\"dangerouslySetInnerHTML\":{\"__html\":\"* \
       { display: none; }\"}},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
    app
  ...
  assert_html
    ...
    ~shell:
      "<!DOCTYPE html><html><head><link rel=\"stylesheet\" href=\"/styles.css\" precedence=\"default\" /><script \
       ...
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"head\",null,{\"children\":[[\"$\",\"link\",null,{\"rel\":\"stylesheet\",\"href\":\"/styles.css\",\"precedence\":\"default\"},null,[],null],[\"$\",\"script\",null,{\"children\":[],\"src\":\"/app.js\",\"async\":true},null,[],null]]},null,[],null],[\"$\",\"body\",null,{\"children\":[[\"$\",\"div\",null,{\"children\":[\"Page \
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><script async src=\"/first.js\"></script><link href=\"/third.css\" \
       ...
       Title\"]},null,[],null],[\"$\",\"meta\",null,{\"name\":\"description\",\"content\":\"Page \
       description\"},null,[],null],[\"$\",\"link\",null,{\"href\":\"/first.css\",\"rel\":\"stylesheet\"},null,[],null],[\"$\",\"title\",null,{\"children\":[\"Second \
       Title\"]},null,[],null],[\"$\",\"meta\",null,{\"name\":\"keywords\",\"content\":\"react, \
       ssr\"},null,[],null],[\"$\",\"link\",null,{\"href\":\"/second.css\",\"rel\":\"stylesheet\"},null,[],null],[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"/first.js\"},null,[],null],[\"$\",\"link\",null,{\"href\":\"/third.css\",\"rel\":\"stylesheet\",\"precedence\":\"high\"},null,[],null],[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"/second.js\"},null,[],null],[\"$\",\"meta\",null,{\"name\":\"author\",\"content\":\"Developer\"},null,[],null],[\"$\",\"div\",null,{\"children\":[\"Body \
       content\"]},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html><head><meta charset=\"utf-8\" /><style>.custom { color: red; }</style><link \
       ...
       data-payload='0:[\"$\",\"html\",null,{\"children\":[[\"$\",\"head\",null,{\"children\":[[\"$\",\"meta\",null,{\"charSet\":\"utf-8\"},null,[],null],[\"$\",\"style\",null,{\"dangerouslySetInnerHTML\":{\"__html\":\".custom \
       { color: red; \
       }\"}},null,[],null],[\"$\",\"link\",null,{\"href\":\"/main.css\",\"rel\":\"stylesheet\"},null,[],null],[\"$\",\"title\",null,{\"children\":[\"My \
       App\"]},null,[],null],[\"$\",\"meta\",null,{\"name\":\"viewport\",\"content\":\"width=device-width\"},null,[],null],[\"$\",\"script\",null,{\"children\":[],\"async\":true,\"src\":\"/app.js\"},null,[],null]]},null,[],null],[\"$\",\"body\",null,{\"children\":[[\"$\",\"div\",null,{\"children\":[\"Content\"]},null,[],null]]},null,[],null]]},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
  ...
  assert_html app
    ~shell:
      "<!DOCTYPE html><html lang=\"en\"><head></head><script \
       data-payload='0:[\"$\",\"html\",null,{\"children\":[],\"lang\":\"en\"},null,[],null]\n\
       '>window.srr_stream.push()</script></html>"
