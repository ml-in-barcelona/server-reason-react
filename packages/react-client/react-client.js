// Do not edit by hand. File generated by `npm run react-client-generate`.
"use strict";
...
// react/build/node_modules/react-client/cjs/react-client-flight.development.js
var require_react_client_flight_development = __commonJS({
  "react/build/node_modules/react-client/cjs/react-client-flight.development.js"(exports2, module2) {
    "use strict";
    module2.exports = function($$$config) {
        ...
        try {
          switch (typeof value) {
            case "object":
              ...
              if ("object" === typeof value.request && "string" === typeof value.request.url)
                return value.request.url;
              if ("object" === typeof value.response && "string" === typeof value.response.url)
      ...
      function waitForReference(referencedChunk, parentObject, key, response, map, path) {
        if (void 0 === response._debugChannel && "pending" === referencedChunk.status && parentObject[0] === REACT_ELEMENT_TYPE && ("4" === key || "5" === key))
          return null;
            ...
            case "E":
              ...
              try {
                ...
                if (response.startsWith("(async function")) {
                  if (parentObject = response.indexOf("(", 15), -1 !== parentObject)
                    return response = response.slice(15, parentObject).trim(), (0, eval)(
                      "({" + JSON.stringify(response) + ":async function(){}})"
                    )[response];
                } else if (response.startsWith("(function")) {
                  if (parentObject = response.indexOf("(", 9), -1 !== parentObject)
                    return response = response.slice(9, parentObject).trim(), (0, eval)(
                      "({" + JSON.stringify(response) + ":function(){}})"
                    )[response];
                } else if (response.startsWith("(class") && (parentObject = response.indexOf("{", 6), -1 !== parentObject))
                  return response = response.slice(6, parentObject).trim(), (0, eval)("({" + JSON.stringify(response) + ":class{}})")[response];
                return function() {
                };
              }
            case "Y":
      ...
      function resolveModule(response, id, model) {
        ...
        if (model = preloadModule(clientReference)) {
          ...
          chunk ? resolveModuleChunk(response, chunk, clientReference) : chunks.set(
            id,
      ...
      function processFullStringRow(response, id, tag, row) {
        switch (tag) {
          ...
          default:
            if ("" === row) {
              if (row = response._chunks, (tag = row.get(id)) || row.set(id, tag = createPendingChunk(response)), "pending" === tag.status || "blocked" === tag.status)
                releasePendingChunk(response, tag), response = tag, response.status = "halted", response.value = null, response.reason = null;
            } else
              tag = response._chunks, (chunk = tag.get(id)) ? resolveModelChunk(response, chunk, row) : tag.set(id, createResolvedModelChunk(response, row));
        }
      }
      ...
      var debugChannelRegistry = "function" === typeof FinalizationRegistry ? new FinalizationRegistry(cleanupDebugChannel) : null, initializingHandler = null, initializingChunk = null, supportsCreateTask = !!console.createTask, fakeFunctionCache = /* @__PURE__ */ new Map(), fakeFunctionIdx = 0, createFakeJSXCallStack = {
      ...
      exports3.close = function(weakResponse) {
        reportGlobalError(weakResponse, Error("Connection closed."));
      };
      exports3.createBoundServerReference = createBoundServerReference;
      exports3.createResponse = function(bundlerConfig, serverReferenceConfig, moduleLoading, callServer, encodeFormAction, nonce, temporaryReferences, findSourceMapURL, replayConsole, environmentName, debugChannel) {
      ...
      exports3.createServerReference = function(id, callServer, encodeFormAction, findSourceMapURL, functionName) {
        function action() {
          var args = Array.prototype.slice.call(arguments);
      ...
      exports3.createStreamState = function() {
        return {
          _rowState: 0,
          _rowID: 0,
          _rowTag: 0,
      ...
      exports3.getRoot = function(weakResponse) {
      ...
      exports3.injectIntoDevTools = function() {
        ...
        if ("undefined" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__)
          ...
          if (hook.isDisabled || !hook.supportsFlight)
            ...
            JSCompiler_inline_result = hook.checkDCE ? true : false;
          }
        }
        return JSCompiler_inline_result;
      };
      exports3.processBinaryChunk = function(weakResponse, streamState, chunk) {
        if (void 0 !== weakResponse.weak.deref()) {
      ...
      exports3.processReply = processReply;
      exports3.processStringChunk = function(weakResponse, streamState, chunk) {
        if (void 0 !== weakResponse.weak.deref()) {
          weakResponse = unwrapWeakResponse(weakResponse);
      ...
      exports3.registerBoundServerReference = registerBoundServerReference;
      exports3.registerServerReference = function(reference, id, encodeFormAction) {
        registerBoundServerReference(reference, id, null, encodeFormAction);
        return reference;
      };
      exports3.reportGlobalError = reportGlobalError;
      return exports3;
    }, module2.exports.default = module2.exports, Object.defineProperty(module2.exports, "__esModule", { value: true });
  }
});

// react/build/node_modules/react-client/flight.js
if (false) {
  module.exports = null;
} else {
  module.exports = require_react_client_flight_development();
}
