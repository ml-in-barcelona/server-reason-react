  $ refmt --parse re --print ml input.re | server-reason-react.router-source-gen --mode handles > Router.ml
  $ refmt --parse re --print ml input.re | server-reason-react.router-interface-gen > Router.mli
  ...
  $ refmt --parse re --print ml unknown-argument.re | server-reason-react.router-source-gen --mode handles
  Fatal error: exception router: unknown router argument ~laoyut
  [2]

  $ refmt --parse re --print ml duplicate-manifest.re | server-reason-react.router-source-gen --mode handles
